...
mahsulotga mosligini _bloklovchi ochiq savol_ deb belgilaydi va u hali
...
| Har rol uchun ruxsat testi                                           | 🟡    | `rbac.contract.spec.ts` (matritsa) + `test/integration/rbac.spec.ts` (4 test) + `role-grant.rules.spec.ts` (21 test — delegatsiya zinasi) + `user-admin.spec.ts` (27, HALI ISHGA TUSHIRILMAGAN). 8 roldan hammasi hamon qamralmagan |
...
**Hozir (2026-09-04 da qayta sanaldi): 27 ✅ / 16 🟡 / 44 ❌**
...
- **Onlayn o'yin UI QO'SHILDI** (`/oyin/[id]` + `live-game.tsx`):
  ...
  "tijorat mahsulotga mos keladimi — Yurist" degan _bloklovchi_
...
| K-21    | **`Pairing` juftlashtirish SABABINI saqlamaydi**                                                            | `prisma/schema.prisma` (Pairing modeli), `swiss-dutch.engine.ts` | Dizayn brifi §5.13 hakam uchun "nega bu juftlik?" panelini "killer feature" deb ataydi va "qaysi FIDE kriteriysi ishladi" degan javobni va'da qiladi. Dvigatel esa qaror izini yozmaydi: qatorda faqat natija bor. Shu sababli frontend paneli (`web/components/pairing-why.tsx`) sababni DA'VO QILMAYDI — u faqat FAKTLARNI (ochko, rang tarixi, float tarixi) ko'rsatadi va buni ochiq aytadi. To'liq iz uchun `Pairing` ga rationale maydoni va dvigateldan qaror jurnali kerak                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| K-22 ✅ | **Ommaviy o'yinchi ro'yxati ichki `userId` ni qaytarardi**                                                  | `player.service.ts`, `GET /players`, `GET /players/:id`          | `PlayerRow` to'g'ridan-to'g'ri javob sifatida berilardi va unda `userId` — hisob identifikatori, JWT `sub` — turardi. Har kim istalgan o'yinchining hisob ID'sini yig'ib olardi; ommaviy sirtda unga ehtiyoj yo'q (hamma murojaat `playerId` bilan boradi). Do'stlar qidiruvini jonli sinash paytida ko'rindi. **TUZATILDI 2026-09-03** — `PublicPlayer` (= `Omit<PlayerRow,"userId">`) qaytariladi; integration test har qatorni tekshiradi                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| K-23 ✅ | **Do'stona chaqiriq raqibga XABAR BERMASDI**                                                                | `play.service.ts` `createFriendChallenge`                        | Chaqiriq o'yinni DARHOL yaratadi va soat ishlay boshlaydi, lekin hodisa yuborilmasdi: raqib o'yin ochilganini faqat sahifani yangilaganda ko'rardi — vaqti esa o'sha paytgacha ketaverardi. Do'stlar oqimining E2E testi yozilgach ko'rindi. **TUZATILDI 2026-09-03** — matchmaking bilan AYNI `PLAY_MATCHED_EVENT` yuboriladi; frontendda tinglovchi sahifadan ilova QOBIG'iga ko'chirildi (`web/lib/play-socket.tsx`), ya'ni xabar qaysi sahifada bo'lsangiz ham yetadi. Taxtada turgan o'yinchi esa TORTIB OLINMAYDI — jonli partiyani tashlab ketish yomonroq                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| K-24 ✅ | **RBAC matritsasiga ROL BERADIGAN yo'l yo'q edi**                                                           | `user_roles` jadvali, `identity/`                                | Matritsa to'liq yozilgan va CI bilan qo'riqlanardi, lekin rollar faqat `prisma/seed.ts` (dev) yoki qo'lda SQL bilan paydo bo'lardi. Ya'ni ishlab turgan platformada hakam tayinlab ham bo'lmasdi va `AuthzService.invalidate` ni hech kim chaqirmasdi. **TUZATILDI 2026-09-04** — `/admin/users` (ro'yxat, rol berish/olib tashlash, bloklash), sof `role-grant.rules.ts` (delegatsiya zinasi: hech kim o'z darajasini ko'paytira olmaydi; oxirgi superadmin qulfi; o'zini bloklash taqiqi), har yozuvda MAJBURIY sabab + authz keshi bekor qilinadi. Frontend: `/konsol/admin`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| K-25 ✅ | **Bloklangan foydalanuvchi sessiyasi tirik qolardi**                                                        | `auth.service.ts` `status` tekshiruvi                            | `SUSPENDED`/`BANNED` faqat KEYINGI login'da tekshirilardi. Bloklangan odam mavjud refresh token bilan ishlab yuraverardi. **TUZATILDI 2026-09-04** — holat o'zgarganda barcha refresh tokenlar bekor qilinadi (`setStatus`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| K-26 ✅ | **Frontend UMUMAN konteynerlanmagan**                                                                       | `web/`                                                           | `web/Dockerfile` yo'q edi, ya'ni frontendni serverga chiqarib bo'lmasdi. **TUZATILDI 2026-09-04** — standalone image (`next start` standalone bilan ishlamaydi), `NEXT_PUBLIC_*` build ARG sifatida                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| K-27 ✅ | **WebSocket CORS har qanday saytga ochiq**                                                                  | `play.gateway.ts:119`                                            | `cors: { origin: true, credentials: true }` — dekorator statik qiymat, konfiguratsiyani ko'ra olmaydi. Xavf cheklangan (token begona saytga ko'rinmaydi, ya'ni faqat anonim tomoshabin ulanardi), lekin prod'da ro'yxatni ochiq qoldirishning sababi yo'q. **TUZATILDI 2026-09-04** — `RedisIoAdapter` uni `CORS_ORIGINS` bilan almashtiradi; bo'sh ro'yxat ATAYLAB e'tiborsiz (aks holda lokal dev'da butun jonli o'yin o'chib qolardi)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
